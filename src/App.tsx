...
const defaultWorkflowForRole = (role: string) => role === "Learner" ? "Mathematics Assignment" : role === "Parent" ? "Child Profile" : role === "Class Teacher" ? "Daily register" : role === "Teacher" ? "Resource publishing" : role === "Finance Officer" ? "Fee Statement" : role === "Admissions Officer" ? "Application Pipeline" : "User Access Control";
